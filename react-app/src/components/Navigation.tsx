      ...
      {mobileMenuOpen && (
        <div id="mobile-menu" className="md:hidden fixed inset-x-0 top-20 bg-[#FDFBF7] z-50 shadow-lg">
          <div className="px-4 py-4 space-y-2">
                  <button onClick={() => { setCurrentView('main'); setMobileMenuOpen(false); navigate('/') }} className="w-full text-left px-4 py-3 uppercase">{txt.nav.start}</button>
              ...
              >
               ...
               {mobileOfertaOpen && (
                 <div id="mobile-oferta" className="pl-4">
                   <button onClick={() => { setCurrentView('offer-overview'); setMobileMenuOpen(false); navigate('/offer') }} className="w-full text-left px-4 py-3">{txt.nav.offerOverview}</button>
                   <button onClick={() => { setCurrentView('cito-config'); setMobileMenuOpen(false); navigate('/offer/cito') }} className="w-full text-left px-4 py-3">{txt.nav.packageCito}</button>
                   <button onClick={() => { setCurrentView('premium-config'); setMobileMenuOpen(false); navigate('/offer/premium') }} className="w-full text-left px-4 py-3">{txt.nav.packagePremium}</button>
                   <button onClick={() => { setCurrentView('consult-config'); setMobileMenuOpen(false); navigate('/offer/consult') }} className="w-full text-left px-4 py-3">{txt.nav.consultations}</button>
                 </div>
               )}
            </div>
            ...
            <div>
              <button onClick={() => { setCurrentView('onas'); setMobileMenuOpen(false); navigate('/about') }} className="w-full text-left px-4 py-3 uppercase">{txt.nav.about}</button>
              <div className="pl-4">
                <a href="tel:+48698354726" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3">Klaudia: {txt.nav.klaudiaPhone}</a>
                <a href="tel:+48697909309" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3">Angelika: {txt.nav.angelikaPhone}</a>
              </div>
            </div>

            <button onClick={() => { setMobileMenuOpen(false); navigate('/faq') }} className="w-full text-left px-4 py-3 uppercase">{txt.nav.faq}</button>
