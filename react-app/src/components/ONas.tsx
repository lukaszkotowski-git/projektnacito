        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="flex gap-4">
              <button onClick={() => setCurrentView('offer-overview')} className="px-6 py-3 bg-[#8C7E6A] text-white rounded-md uppercase text-sm tracking-wider hover:bg-[#7A6C58] transition">Poznaj ofertę</button>
              <button onClick={() => setCurrentView('main')} className="px-6 py-3 border border-[#E5DED4] rounded-md uppercase text-sm tracking-wider hover:bg-gray-50 transition">Wróć</button>
            </div>
          </div>
