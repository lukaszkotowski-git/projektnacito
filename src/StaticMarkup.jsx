...
<head>
    ...
    <title>Projekt na Cito | Konfigurator</title>
...
<body class="antialiased">
    ...
    <main id="view-main" class="pt-32 pb-24">
        <section class="px-6 text-center mb-20">
            <h1 class="text-5xl md:text-7xl serif mb-8 fade-in visible">Wybierz sw32y <br><span class="italic text-[#8C7E6A]">zakres wsparcia</span></h1>
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                <div onclick="showView('cito-config')" class="card-choice p-10 rounded-[2.5rem] cursor-pointer text-left group">
                    <div class="text-[10px] font-bold uppercase tracking-widest text-[#8C7E6A] mb-6">Najcz22ciej wybierany</div>
                    <h3 class="text-3xl serif mb-4">Pakiet na Cito</h3>
                    <p class="text-sm text-gray-500 leading-relaxed mb-8">Skonfiguruj swoje pomieszczenia i otrzymaj b2yskawiczn2 wycen9 za konkretne sztuki.</p>
                ...
                <div onclick="showView('premium-config')" class="card-choice p-10 rounded-[2.5rem] cursor-pointer text-left group">
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed mb-8">Wycena na podstawie metra32u. Najlepszy wyb2r przy projektowaniu ca22ego mieszkania lub domu.</p>
                    <span class="text-[10px] font-bold uppercase tracking-widest flex items-center">
                        Oblicz wycen9 <svg class="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17 8l4 4m0 0l-4 4m4-4H3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </span>
                </div>
                ...
                <div onclick="showView('consult-config')" class="card-choice p-10 rounded-[2.5rem] cursor-pointer text-left group">
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed mb-8">Szybka porada ekspercka online lub na budowie. Idealne rozwi2zanie na konkretne dylematy.</p>
                    <span class="text-[10px] font-bold uppercase tracking-widest flex items-center">
                        Um5w si9 <svg class="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17 8l4 4m0 0l-4 4m4-4H3" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </span>
                </div>
            </div>
        </section>
    ...
    <!-- KONFIGURATOR PAKIETU NA CITO -->
    <main id="view-cito-config" class="hidden pt-32 pb-24 px-6">
        <div class="max-w-4xl mx-auto">
            <button onclick="goToMain()" class="text-[10px] uppercase tracking-widest font-bold flex items-center mb-8 hover:text-[#8C7E6A] transition">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M15 19l-7-7 7-7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Wr2 do wyboru
            </button>

... (truncated - original HTML inserted)
`}
    }} />
  )
}